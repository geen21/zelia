      ...
      <div className="flex flex-col flex-1 min-h-0 gap-4">
        <div className="bg-white rounded-3xl p-4 border border-gray-200 shadow-card shrink-0">
          <div className="flex flex-col items-center gap-3 text-center">
            <h1 className="text-xl font-bold text-gray-900">Chat communautaire</h1>
            <p className="text-sm text-text-secondary">Échange avec les autres utilisateurs de Zélia.</p>
          </div>
        </div>
