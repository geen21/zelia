      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            a complété avec succès le <strong>parcours d'orientation</strong> Zélia,
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: 18, color: '#c1ff72', fontWeight: 900, lineHeight: 1 }}>OK</div>
              <div style={{ fontSize: 8, color: '#c1ff72', fontFamily: 'Arial, sans-serif' }}>PARCOURS</div>
            </div>
