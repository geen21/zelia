...
const CORE_QUEST_SEQUENCE = [
  ...
  { id: 'star_method', label: 'Organiser ses candidatures' },
  ...
  { id: 'mentor_others', label: 'Explorer des métiers possibles' },
  ...
  { id: 'level_31', label: 'Explorer ses options : compétences' },
