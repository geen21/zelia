...
export default function Niveau13() {
  ...
  const messages = useMemo(() => {
    ...
    const intro = `Re ! En avant pour le niveau 13${prenom ? ` ${prenom}` : ''}. On va entrer dans le vif du sujet, avec un module pour apprendre Ã  se prÃ©senter Ã  lâ€™oral.`
    return ([
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="relative bg-white border border-gray-200 rounded-2xl p-8 shadow-2xl text-center max-w-md w-11/12">
            ...
            <h3 className="text-2xl font-extrabold mb-2">Niveau 13 rÃ©ussi !</h3>
