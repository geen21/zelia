...
export const TOOLBOX_ITEMS = [
  ...
  { id: 'emplois', legacyLevels: [9], path: '/app/emplois', title: "Recherche d'emplois", category: 'Explorer métiers & formations', icon: 'ph-briefcase', description: "Rechercher des offres d'emploi reelles" },
  ...
  { id: 'axes-amelioration', legacyLevels: [19], componentLevel: 19, path: '/app/outils/axes-amelioration', title: "Axes d'amelioration", category: 'Me connaître', icon: 'ph-trend-up', description: "5 points d'amelioration personnalises par l'IA" },
