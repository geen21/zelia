                    ...
                    <div className="mb-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {jobSuggestions.map((suggestion) => (
                          <button
                            key={`kw-suggestion-${suggestion}`}
                            type="button"
                            onClick={() => updateForm('keyword', suggestion)}
                            className="rounded-full border border-gray-200 bg-white px-3 py-1 text-xs font-medium text-gray-700 transition hover:border-black hover:bg-gray-50"
                          >
                            {suggestion}
                          </button>
                        ))}
