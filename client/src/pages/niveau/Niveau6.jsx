      ...
      {completed && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="relative w-full max-w-md rounded-3xl border border-gray-200 bg-white p-8 text-center shadow-2xl">
            ...
            <h3 className="mt-4 text-2xl font-extrabold text-gray-900">Niveau 6 validé !</h3>
            <p className="mt-2 text-gray-500">
              Tu sais maintenant rechercher et comparer les formations qui t’intéressent. Continue ton parcours pour aller encore plus loin.
            </p>
